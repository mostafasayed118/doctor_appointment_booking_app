...
class _SuccessView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ConstrainedContent(
      // The success view is a short centered column; capping it keeps the
      // button a sane width on tablet/desktop.
      maxWidth: 480,
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AppButton(
              ...
              onPressed: () =>
                  context.go(rescheduled ? '/appointments' : '/doctors'),
            ),
          ],
        ),
      ),
